  ...
  return (
    <div className="min-h-full flex flex-col items-center justify-center p-6 sm:p-12 text-center max-w-4xl mx-auto transition-colors">
      <div
        ...
        onDrop={handleDrop}
        className={`w-full max-w-2xl border-2 border-dashed rounded-3xl p-8 sm:p-10 transition-all ${
          isDragOver
            ? "border-indigo-500 bg-indigo-500/10 scale-[1.01]"
            : "border-slate-300 dark:border-[#262626] hover:border-indigo-400 dark:hover:border-[#383838] bg-white/90 dark:bg-[#141414]/90 backdrop-blur-xl shadow-xl shadow-slate-200/50 dark:shadow-2xl dark:shadow-black/60"
        }`}
      >
        <div className="w-16 h-16 rounded-2xl bg-indigo-50 dark:bg-indigo-600/10 border border-indigo-100 dark:border-indigo-500/20 text-indigo-600 dark:text-indigo-400 flex items-center justify-center mx-auto mb-5 shadow-inner">
        ...
        <div className="flex flex-wrap items-center justify-center gap-3">
          <button
            ...
            className="px-6 py-2.5 rounded-xl bg-indigo-600 hover:bg-indigo-500 active:scale-95 text-white font-medium text-sm transition-all shadow-lg shadow-indigo-600/25 flex items-center gap-2 cursor-pointer"
          >
        ...
        {error && (
          <div className="mt-4 text-xs text-rose-600 dark:text-rose-400 bg-rose-50 dark:bg-rose-500/10 p-2.5 rounded-lg border border-rose-200 dark:border-rose-500/20">
            {error}
          </div>
        )}
      ...
      <div className="w-full max-w-2xl mt-8">
        <div className="flex items-center gap-2 text-xs font-semibold uppercase tracking-wider text-slate-500 dark:text-zinc-400 mb-3 justify-center">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
          {SAMPLE_TEMPLATES.map((sample) => (
            <button
              ...
              className="p-3.5 rounded-xl bg-white/90 dark:bg-[#141414]/90 border border-slate-200 dark:border-[#262626] hover:border-indigo-400 dark:hover:border-[#0099ff]/50 hover:bg-slate-50 dark:hover:bg-[#1c1c1c] hover:shadow-md hover:shadow-indigo-500/5 text-left transition-all group flex items-center justify-between cursor-pointer"
            >
              <div>
              ...
              <span className="text-[10px] font-mono font-medium px-2 py-0.5 rounded bg-indigo-50 dark:bg-indigo-500/10 text-indigo-600 dark:text-indigo-400 border border-indigo-200 dark:border-indigo-500/20">
                {sample.badge}
              </span>
            </button>
          ))}
